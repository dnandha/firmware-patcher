...
def patch_firmware():
    ...
    patchorzip = flask.request.form.get('patchorzip', None)
    patch = patchorzip == "Patch!"
    ...
    try:
        scoot = data[0x100:0x10f].decode('ascii')
    except:
        return 'Falsche Datei ausgewählt.', 400

    model = ""
    version = ""
    if scoot == "Scooter_MiP2_V0":
        model = "pro2"
        version = "DRV236"
    elif scoot == "Scooter_Mi1S_V0":
        model = "1s"
        version = "DRV304"
    else:
        return 'Falsche Datei ausgewählt.', 400
    ...
    if patch:
        ...
        if not ((version == "DRV236" and md5 == '194df3966443d8a913b47006119d45d9')
            or (version == "DRV304" and md5 == '682fc3b89122ff0a21ebe2fa3ada4908')):
            return 'Datei bereits gepatcht. Zum Patchen bitte Vanilla Datei auswählen.', 400
